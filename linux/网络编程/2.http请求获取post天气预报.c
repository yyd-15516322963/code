...
int main()
{
	...
	//获取天气预报网站的ip地址
	struct hostent *result=gethostbyname("kztq.market.alicloudapi.com");
	...
	// https://kztq.market.alicloudapi.com/api/weather/history
	const char *postreq="POST /api/weather/history HTTP/1.1\r\n"
	                    "Host:kztq.market.alicloudapi.com\r\n"
						"Content-Type:application/x-www-form-urlencoded\r\n"
						"Content-Length:61\r\n"
						"Authorization:APPCODE 442b565c2b4743b38c410a5b74fcbbe7\r\n\r\n"
						"cityid=101280103&year=2026&month=3&date=2026-03-01_2026-03-05";
	send(tcpsock,postreq,strlen(postreq),0);
	
	//立马接受服务器返回的json格式数据
	recv(tcpsock,rbuf,30000,0);
	printf("杭州快证签公司服务器给我返回的广州从化区天气信息如下: %s\n",rbuf);
